-- DEVIL HUB V1.01 - FIXED NEW UI BUILD
-- New UI loaded as a local library; original DEVIL feature block preserved.

local function __load_new_ui()
    local library
    do
        local ui_options = {
